...
def homepage(request):
    if request.method == 'POST':
        ...
        Our team will carefully review your request and get back to you within 24–48 hours.

        Meanwhile, let’s stay connected:  
        📲 WhatsApp: https://chat.whatsapp.com/Izdr6dbHy9e8bCnBnNJpQG    
        📸 Instagram: https://www.instagram.com/rp_innovations_official?igsh=MTRqNzgxM3Bzand1cg==    

        For urgent queries: rpinnovations.info@gmail.com | +91 9354712773
